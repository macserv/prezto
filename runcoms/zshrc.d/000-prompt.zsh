...
t_l=( 'dir_writable' 'dir' 'vcs' );       t_r=( 'background_jobs' 'my_caffeinate' 'node_version' 'swift_version' 'go_version' 'time' )
...
# typeset -g POWERLEVEL9K_NODE_VERSION_PROJECT_ONLY='true' # Only show segment when in project using Node
typeset -g POWERLEVEL9K_NODE_VERSION_FOREGROUND='silver' # Terminal color 15
