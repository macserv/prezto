...
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=('status' 'background_jobs' 'my_caffeinate' 'time' 'my_cpu_temp' 'swift_version')
...
POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION="$(echo '\uF1A7') " # '' Pied Piper square logo
